...
[InitializeOnLoad]
public class ShapesWindow : EditorWindow
{
    ...
    //Dispalys information about the positions of each corner of the parallelogram and its area and the circle's area
    void DisplayCoordinates()
    {
        ...
        GUILayout.Label("The coordinates of point 1 are (rounded up) " + ParallelogramDrawer.main.Corners[0].position, EditorStyles.label);
        GUILayout.Label("The coordinates of point 2 are (rounded up)" + ParallelogramDrawer.main.Corners[1].position, EditorStyles.label);
        GUILayout.Label("The coordinates of point 3 are (rounded up)" + ParallelogramDrawer.main.Corners[2].position, EditorStyles.label);
